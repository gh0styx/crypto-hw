          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Wipe all trades and balance history</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Manage your API keys (Experimental)</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Alerts for price targets</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {isConfirmOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm animate-in fade-in p-4">
          <div className="bg-white rounded-3xl w-full max-w-sm p-8 shadow-2xl relative animate-in zoom-in-95 duration-200 text-center">
            ...
            <h3 className="text-xl font-bold text-foreground mb-2">Reset Portfolio?</h3>
            <p className="text-sm font-medium text-muted-foreground mb-8">
              This action is irreversible. All your trade history, holdings, and statistics will be wiped globally.
            </p>
