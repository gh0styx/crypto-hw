...
export const metadata: Metadata = {
  ...
  description: "Real-time crypto price analysis, interactive 24h charts, and mock trading simulation for Bitcoin, Ethereum, and more.",
  keywords: ["crypto", "trading", "dashboard", "bitcoin", "ethereum", "real-time", "mock trading"],
};
